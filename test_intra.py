...
def main(config_file, exp_suffix):
    ...
    print('*****************************aaaaaa:',cfg.TEST.SNAPSHOT_DIR[0])
    print('Using config:')
    pprint.pprint(cfg)
    # load models
    models = []
    ...
    test_dataset = CityscapesDataSet(root=cfg.DATA_DIRECTORY_TARGET,
                                     list_path='/home/ailab/ailab/LJW/our_code/ADVENT/advent/dataset/cityscapes_list/{}.txt',
    ...
    #                                  list_path='../ADVENT/advent/dataset/mapillary_list/{}.txt',
    #                                  set=cfg.TEST.SET_TARGET,
    #                                  info_path=cfg.TEST.INFO_TARGET,
    #                                  crop_size=cfg.TEST.INPUT_SIZE_TARGET,
    #                                  mean=cfg.TEST.IMG_MEAN,
