...
cfg.DATA_LIST_SOURCE = "/home/ailab/ailab/LJW/our_code/dataset/synthia_list/{}.txt"
cfg.DATA_LIST_TARGET = "/home/ailab/ailab/LJW/our_code/dataset/cityscapes_list/{}.txt"

# Directories
cfg.DATA_DIRECTORY_SOURCE = "/home/ailab/ailab/LJW/our_code/dataset/SYNTHIA"
cfg.DATA_DIRECTORY_TARGET = "/home/ailab/ailab/LJW/our_code/dataset/Cityscapes"

# Number of object classes
cfg.NUM_CLASSES = 16 # 19
# Exp dirs
cfg.EXP_NAME = ''
cfg.EXP_ROOT = "/home/ailab/ailab/LJW/our_code/experiments/intra"
...
cfg.TRAIN.INPUT_SIZE_SOURCE = (1280, 720)#(1280, 720) (640, 320)
cfg.TRAIN.INPUT_SIZE_TARGET = (1024, 512) #(1024, 512) (640, 320)
# Class info
cfg.TRAIN.INFO_SOURCE = ''
#cfg.TRAIN.INFO_TARGET = str(project_root / 'advent/dataset/cityscapes_list/info.json')
cfg.TRAIN.INFO_TARGET = "/home/ailab/ailab/LJW/our_code/dataset/cityscapes_list/info16class.json"
#cfg.TRAIN.INFO_TARGET = str(project_root / 'advent/dataset/mapillary_list/info.json')
# Segmentation network params
cfg.TRAIN.MODEL = 'DeepLabv2'
cfg.TRAIN.MULTI_LEVEL = False # True
cfg.TRAIN.RESTORE_FROM = ''
cfg.TRAIN.IMG_MEAN = np.array((104.00698793, 116.66876762, 122.67891434), dtype=np.float32)
cfg.TRAIN.LEARNING_RATE = 2.5e-4 #2.5e-4
...
cfg.TEST.INPUT_SIZE_TARGET = (1024, 512)#(1024, 512) (640, 320)
cfg.TEST.OUTPUT_SIZE_TARGET = (2048, 1024)
#cfg.TEST.INFO_TARGET = str(project_root / 'advent/dataset/cityscapes_list/info.json')
cfg.TEST.INFO_TARGET = '/home/ailab/ailab/LJW/our_code/dataset/cityscapes_list/info16class.json'
#cfg.TEST.INFO_TARGET = str(project_root /'advent/dataset/mapillary_list/info.json')
