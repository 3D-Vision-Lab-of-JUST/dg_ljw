...
cfg.DATA_LIST_SOURCE = "/home/ailab/ailab/LJW/our_code/dataset/synthia_list/{}.txt" # str(project_root / "dada/dataset/synthia_list/{}.txt")
cfg.DATA_LIST_TARGET = "/home/ailab/ailab/LJW/our_code/dataset/cityscapes_list/{}.txt"# str(project_root / "dada/dataset/cityscapes_list/{}.txt")
# Directories
cfg.DATA_DIRECTORY_SOURCE = "/home/ailab/ailab/LJW/our_code/dataset/SYNTHIA" # str(project_root / "data/SYNTHIA")
cfg.DATA_DIRECTORY_TARGET = "/home/ailab/ailab/LJW/our_code/dataset/Cityscapes"# str(project_root / "data/Cityscapes")
# Number of object classes
cfg.NUM_CLASSES = 16 # 16
cfg.USE_DEPTH = True
# Exp dirs
cfg.EXP_NAME = ""
cfg.EXP_ROOT = "/home/ailab/ailab/LJW/our_code/experiments"
...
cfg.TRAIN.INPUT_SIZE_SOURCE = (1280, 760)#(1280, 760) (640,320)
